...
public class C01_projeyeSeleniumEkleme {
    /*
    Bir projede selenium ile otomasyon yapabilmek için
    projeye 2 sey eklemeliyiz
    1- Selenium kütüphanesi
    2- kullanmak istediğimiz browser in selenium driver i
    (Biz sadece chrome kullanıp sonra daha gelismis framework lara geçiş yapacaz)
